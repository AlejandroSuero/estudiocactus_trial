...
function Sidebar({ materials }: SidebarProps) {
  ...
  const handleMaterialClick = useCallback(
    ...
    [activePoint, selectMaterial, closeSidebar]
  );

  const sidebar = useMemo(() => {
    const pointId = activePoint?.id;
    if (!pointId) return <p>No point selected</p>;
    return (
      <aside
  ...
  }, [materials, activePoint, handleMaterialClick, isSidebarOpen, closeSidebar]);
